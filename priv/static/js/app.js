...
;require.register("web/static/js/flash.js", function(exports, require, module) {
'use strict';

var flashHolder = document.getElementById('flash-holder');

var delayedClear = function delayedClear(element) {
  if (!element) return;

  setTimeout(element.remove.bind(element), 2000);
};

delayedClear(flashHolder);
});

;require.register("web/static/js/home.js", function(exports, require, module) {
'use strict';

var signUpTopButton = document.getElementById('index-sign-up-top');
var signUpBottomButton = document.getElementById('index-sign-up-bottom');

var redirectTo = function redirectTo(destination) {
  return function () {
    window.location.href = destination;
  };
};

signUpTopButton && signUpTopButton.addEventListener('click', redirectTo('/sign_up'));

signUpBottomButton && signUpBottomButton.addEventListener('click', redirectTo('/sign_up'));
});
...
function setUpChat() {
  var channel = socket.channel('room:' + chatInput.dataset.roomid, {});
